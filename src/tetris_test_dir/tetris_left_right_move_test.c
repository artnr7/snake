#include "../brick_game/tetris/tetris_include/tetris_moving/tetris_left_right_move.h"
...
Suite *tetris_left_right_move_suite(void) {
  ...
  s = suite_create("tetris_left_right_move_test_suite");
  tc_left_right_move = tcase_create("tetris_left_right_move_test_suite");
